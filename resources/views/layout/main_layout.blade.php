...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="/simpel" class="navbar-brand">
        <img src="{{ asset('adminlte/dist/img/hermina-logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"><b>SIMPEL</b></span>
      </a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="{{ route('farmasi.konsumsi.index') }}" class="dropdown-item">Farmasi Konsumsi</a></li>
          ...
          <li class="nav-item dropdown"> --}}
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="{{ route('antrol.index') }}" class="dropdown-item">Permintaan </a></li>
              <li><a href="{{ route('antrol.index') }}" class="dropdown-item">Master Barang</a></li>
              <li><a href="{{ route('antrol.index') }}" class="dropdown-item">Laporan Permintaan</a></li>
